...
def generate_asimmetric_keys(key_len: str) -> tuple[str, str]:
...
def encrypt_simmetric_key(public_key: str, simmetric_key: str, key_len: str):
...
def decrypt_simmetric_key(private_key: str, c_key: str):
